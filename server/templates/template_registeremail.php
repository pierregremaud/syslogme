                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            <h1 class="h3" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="left">Welcome to {{ APP_NAME }}</h1>
                                            ...
                                            <div class="space-y-3">
                                              <p class="text-blue-700" style="line-height: 24px; font-size: 16px; color: #084298; width: 100%; margin: 0;" align="left">You just created an account on {{ APP_NAME }} with the email [{{ RECIPIENT_EMAIL }}].</p>
                                              ...
                                              <p class="text-blue-700" style="line-height: 24px; font-size: 16px; color: #084298; width: 100%; margin: 0;" align="left">Please use below button to verify your email and activate your account.</p>
                                            </div>
                                            <table class="s-5 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                              <tbody>
                                                <tr>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;" align="center" bgcolor="#0d6efd">
                                                    <a href="{{ REDIRECT_URL }}" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #0d6efd; padding: 8px 12px; border: 1px solid #0d6efd;">Activate your account</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                                            ...
                                            <p class="text-blue-700" style="line-height: 24px; font-size: 16px; color: #084298; width: 100%; margin: 0;" align="left">If above button does not work, copy the link given below and paste into your browser.</p>
                                            <table class="s-5 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                              <tbody>
                                                <tr>
                                                  <td style="line-height: 20px; font-size: 20px; width: 100%; height: 20px; margin: 0;" align="left" width="100%" height="20">
