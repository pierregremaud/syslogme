                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                            <h1 class="h3" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="left">{{ APP_NAME }}</h1>
                                            ...
                                            <h5 class="text-teal-700" style="color: #13795b; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;" align="left">New email sent to : {{ RECIPIENT_EMAIL }}</h5>
                                            ...
                                            <div class="space-y-3">
                                              <a class="text-teal-700" href="mailto:{{ SENDER_EMAIL }}?subject=Mail%20from%20our%20Website" style="color: #13795b;">Senders name : <span class="text-blue-700" style="color: #084298;">{{ SENDER_NAME }}</span></a>
                                              ...
                                              <p class="text-blue-700" style="line-height: 24px; font-size: 16px; color: #084298; width: 100%; margin: 0;" align="left">Content :</p>
                                              <table class="s-3 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                                <tbody>
                                                  <tr>
                                                    <td style="line-height: 12px; font-size: 12px; width: 100%; height: 12px; margin: 0;" align="left" width="100%" height="12">
                                              ...
                                              <p class="text-blue-700" style="line-height: 24px; font-size: 16px; color: #084298; width: 100%; margin: 0;" align="left">{{ MESSAGE_CONTENT }}</p>
                                            </div>
                                            <table class="s-5 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                              <tbody>
                                                <tr>
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td style="line-height: 24px; font-size: 16px; border-radius: 6px; margin: 0;" align="center" bgcolor="#0d6efd">
                                                    <a href="mailto:{{ SENDER_EMAIL }}?subject=Mail%20from%20our%20Website" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #0d6efd; padding: 8px 12px; border: 1px solid #0d6efd;">Reply to sender</a>
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
